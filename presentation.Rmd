...
png("map1.png")
map1 <- ggmap(map) + geom_point(aes(x = Longitude, y = Latitude, size=number_of_stops, col=Transport.tCO2e.yr.), data = LAnarrow %>% filter(distance == "within1km"), alpha = 1) + labs(x="")
```
